...
instance deletion tracking, and comparison of rectangles by area.
"""
...
class Rectangle:
    ...
    def __del__(self):
        """Print a message when the instance is deleted and decrement instance
        count."""
        print("Bye rectangle...")
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Return the bigger rectangle based on area, or rect_1 if they are
        equal."""
